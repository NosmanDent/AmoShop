...
import { getProductDataBody } from "../ProductStoreBody";
...
const ProductDetailsBody = () => {
  ...
  const product = getProductDataBody(id); // Get the product data based on the ID
  ...
  return (
    <div className=" px-6 md:px-8 mt-5 flex flex-col h-screen w-full mb-[600px] md:mb-[200px]">
      <Link to="/shop/body" className="mb-10">
        <GrClose />
      </Link>
