...
// Define the KidsBabies functional component
const KidsBabies = () => {
  return (
    <section>
      {/* Kids & Babies section */}
      <div>
        {/* Banner with title and "Home" link */}
        <div className="flex flex-1  w-full h-[300px] kids_g mb-20">
          <h1 className="lg:text-6xl text-5xl font-serif font-bold text-stone-200 flex items-center justify-center mx-auto">
            KIDS & BABIES
          </h1>
      ...
      {/* Display products using ProductCardKids */}
      <div className="">
        <div className="flex flex-wrap items-center justify-center">
          {productsArrayKids.map((product, idx) => (
            <div className="" key={idx}>
              <ProductCardKids product={product} />
            </div>
          ))}
        </div>
      </div>
      {/* Display a related article using Swiper */}
